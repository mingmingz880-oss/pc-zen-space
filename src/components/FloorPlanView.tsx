...
const zones: Zone[] = [
  {
    ...
    name: "办公区",
    deviceCount: 15,
    position: { x: 0, y: 0, width: 25, height: 35 },
  ...
  },
  {
    ...
    name: "会议室",
    deviceCount: 8,
    position: { x: 0, y: 35, width: 25, height: 25 },
  ...
  },
  {
    ...
    name: "产品展示区",
    deviceCount: 18,
    position: { x: 25, y: 0, width: 30, height: 35 },
  ...
  },
  {
    ...
    name: "休息区",
    deviceCount: 6,
    position: { x: 25, y: 35, width: 30, height: 25 },
  ...
  },
  {
    ...
    name: "展示区-主展厅",
    deviceCount: 24,
    position: { x: 55, y: 0, width: 45, height: 35 },
  ...
  },
  {
    ...
    name: "舞台区",
    deviceCount: 20,
    position: { x: 55, y: 35, width: 45, height: 25 },
  ...
  },
  {
    ...
    name: "展厅-左",
    deviceCount: 6,
    position: { x: 0, y: 60, width: 40, height: 40 },
  ...
  },
  {
    ...
    name: "展厅-右",
    deviceCount: 7,
    position: { x: 40, y: 60, width: 60, height: 40 },
    color: "rgba(251, 207, 232, 0.4)",
    devices: {
      空调: { total: 2, active: 1 },
      灯光: { total: 3, active: 2 },
